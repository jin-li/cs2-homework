...
struct part *erase_part(int number);
void insert(void);
void search(void);
void update(void);
void print(void);
...
void erase(void)
{
    ...
    p = find_part(number);
    if(p != NULL){
        inventory = erase_part(number);
        printf("Part %d was erased.\n",number);
    } else
 ...
 *          inventory list; the list remins sorted by      *
 ...
 *          change in quantity on hand andupdates the      *
 *          database.                                      *
 ***********************************************************/
void update(void)
{
...
/***********************************************************
 * print : Prints a lising of all parts in the database,   *
